...
import { errorMeg, successMeg, yearOption } from "@/modules/utils";
import { closeDoulaModal } from "../../../Redux/modalSlice";
import closeicon from "../../../Assets/arrow/close.png";
import { postApi } from "@/Redux/api";

const ResumePage = ({ showBackBtn = false, setCurrent }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await postApi("/doula/profile/resume", formData).then((res) => {
        if (res?.data?.success) {
                        ...
                        {yearOption()?.map((d) => {
                          return (
                            <option
                              ...
                              value={d}
                              onClick={() =>
                                setValue(`year_of_employeement.${index}.to`, d)
                              }
                            >
                              {d}
                            </option>
