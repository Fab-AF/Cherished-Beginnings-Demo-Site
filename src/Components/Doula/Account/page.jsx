...
const DoulaProfile = ({ showBackBtn = false, setCurrent }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await postApi("/doula/profile/generalInformation", formData).then(
        (res) => {
          if (res?.data?.success) {
        ...
        <div className="genrelinfomaincontainer">
          ...
          <div className="accformcontainer">
            ...
            <div className="acccinputboxcont">
              <label htmlFor=""></label>
              <div
                className="addmorebutton d-flex align-items-center"
                onClick={() => append({ value: "" })}
              >
                <Image src={addmore} alt="addmoreicon" /> Add More
              </div>
            </div>
            {/* {errors.language && (
          ...
          <div className="acccinputboxcont">
            ...
            <div className="buttonparentsaveanddelete accbtngrp mt-4">
